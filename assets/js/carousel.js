class Carousel {
    constructor (params) {
      ...
      const settings = {...{interval: 7000, containerID: '#carousel', slideID: '.slide', isPlaying: true}, ...params};
    ...
    _initProps () {
      ...
      this.FA_PLAY = '<i class="fab fa-google-play"></i>';
      this.FA_PREV = '<i class="fas fa-caret-left"></i>';
      this.FA_NEXT = '<i class="fas fa-caret-right"></i>';
